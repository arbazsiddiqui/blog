...
![IMDb ratings on Rotten Tomatoes](./images/rottenFinal.webp)
...
![Alert on reload](./images/rottenAlert.webp)
...
![IMDb ratings on reload](./images/rottenReload.webp)
...
![Message received](./images/messageReceived.webp)
