# PRODUCT.md — arbazsiddiqui.me

## What this is
The personal site of Arbaz Siddiqui, a senior software engineer (9 years, distributed
systems) who now builds AI infrastructure and ships finished products with it. The site
exists to get him hired by small AI-native startups (10–50 people, remote) and to win
consulting work for his content-automation pipelines.

## The mechanism (one sentence)
One engineer who builds the machinery around AI models and then proves it by shipping:
an open 12B model that tops its class ($40 of GPU), two live App Store apps, and
autonomous media channels doing 500K monthly views with nobody in the loop.

## Audience & scene
Founders/CTOs of seed-stage AI startups and senior engineers, evaluating a candidate
link on a laptop between meetings. HN/GitHub culture. They decide in ~30 seconds
whether this person is real; proof beats adjectives.

## Product truth (verified facts only — never invent)
- Ozan-12B: lowest slop score of any 12B on EQ-Bench Creative Writing v3; beats a 27B;
...
## Brand commitments (pinned by Arbaz)
...
## Voice
First person, plain, concrete, warm; numbers stated once, no hype adjectives.
